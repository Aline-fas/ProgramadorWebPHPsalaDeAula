...
class Cliente {
    ...
    //Metodo construtor
    public function __construtor(int $idCliente,string $nome,string $dataNascimento,string $orgao,string $cpf,string $estadoCivil,string $sexo,string $email,string $senha,bool $ativo){
        $this->nome = $nome;
